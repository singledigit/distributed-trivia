...
const {
  phase, displayName, nameError, questionCount, categoryName,
  categoryColor, gameMode, currentQuestion, countdownSeconds, finalScore,
  questionsAnswered, totalQuestions, questionResults, isNameValid,
  difficultyLabel, difficultyClass, progressPercent, categoryTheme,
  handleJoin, submitAnswer, skipQuestion, requestMoreTime, skipFromTimeout,
